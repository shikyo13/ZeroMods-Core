package com.zeromods.core.fabric;
...
public final class NetworkSavedData extends SavedData {
    ...
    public static NetworkSavedData get(ServerLevel level, String name) {
        ...
        return level.getDataStorage().computeIfAbsent(new SavedData.Factory<>(NetworkSavedData::new, NetworkSavedData::load, null),name);
    }
    public static NetworkSavedData load(CompoundTag data, HolderLookup.Provider registries) {
    ...
    @Override public CompoundTag save(CompoundTag data, HolderLookup.Provider registries) {
